...
exampleLayout = mkLayout $ Vis $
  let
    ...
    mkMsgbox msg =
      ...
      substrate (LRTB 3 3 3 3) (curve (PhaseCurvature Curvature) (PhaseColor $ \colorPhase -> rgb colorPhase 130 200) (PhaseConst (Direction True False)) (PhaseConst [(2 :: Unsigned), (3 :: Unsigned), (3 :: Unsigned) , (5 :: Unsigned)]) (2 :: Signed) ) $
